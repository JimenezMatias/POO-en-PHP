-- =====================================================
-- CORREGIR TODOS LOS SPU DE DETALLE DE VENTA
-- =====================================================

-- 1. SPU AGREGAR PRODUCTO AL DETALLE
...
-- 2. SPU ELIMINAR PRODUCTO DEL DETALLE
DROP PROCEDURE IF EXISTS spu_eliminarProductoDetalle;

DELIMITER $$

CREATE PROCEDURE spu_eliminarProductoDetalle(
    IN p_id_venta INT,
    IN p_codigo VARCHAR(30)
)
BEGIN
    ...
    WHERE id_venta = p_id_venta AND codigo = p_codigo;
...
-- 3. SPU OBTENER DETALLE DE VENTA
