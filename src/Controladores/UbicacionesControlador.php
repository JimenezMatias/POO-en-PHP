...
class UbicacionesControlador {
    ...
    public function __construct(UbicacionesService $service) {
    ...
    public function crear(Request $request, Response $response): Response {
        ...
        try {
            ...
            $response->getBody()->write(json_encode(['mensaje' => 'ubicacion creado correctamente']));
    ...
    public function editar(Request $request, Response $response, array $args): Response {
        ...
        try {
            ...
            $response->getBody()->write(json_encode(['mensaje' => 'ubicacion actualizado correctamente']));
            return $response->withHeader('Content-Type', 'application/json');
        } catch (InvalidArgumentException $e) {
            $response->getBody()->write(json_encode(['error' => $e->getMessage()]));
            return $response->withStatus(400)->withHeader('Content-Type', 'application/json');
    ...
    public function eliminar(Request $request, Response $response, array $args): Response {
        ...
        try {
            ...
            $response->getBody()->write(json_encode(['mensaje' => 'ubicacion eliminado correctamente']));
            return $response->withHeader('Content-Type', 'application/json');
        } catch (InvalidArgumentException $e) {
            $response->getBody()->write(json_encode(['error' => $e->getMessage()]));
            return $response->withStatus(400)->withHeader('Content-Type', 'application/json');
